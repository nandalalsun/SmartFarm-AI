  ...
  return (
    <div className="pt-20 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-white mb-4 md:mb-0">Bill Scanner</h1>
      ...
      {activeTab === 'scan' && (
        <div className="max-w-xl mx-auto">
          <div className="bg-slate-900 rounded-2xl p-8 border border-slate-800 shadow-2xl">
            <h2 className="text-xl font-semibold text-center text-slate-200 mb-6">Upload a Bill</h2>
            ...
            <div className="w-1/2 bg-black flex flex-col items-center justify-center p-4 border-r border-slate-700 relative">
              {selectedBill ? (
                <div className="text-center">
                  ...
                  <p className="text-xs text-slate-700 font-mono mt-2 break-all max-w-xs">
                ...
                <>
                  <div className="p-4 border-b border-slate-700 flex justify-between items-center bg-slate-800/50">
                    ...
                    {selectedBill.parsedData?.confidence_score && (
                      <span
                        className={`text-xs px-2 py-1 rounded-full ${selectedBill.parsedData.confidence_score > 0.8 ? 'bg-green-500/20 text-green-300' : 'bg-yellow-500/20 text-yellow-300'}`}
                      >
                    ...
                    <div className="flex justify-end pt-4 border-t border-slate-700">
                      <div className="text-right">
                        ...
                        <p className="text-3xl font-bold text-emerald-400">
                          {selectedBill.parsedData?.data?.total_amount}
                        </p>
                      </div>
                    </div>
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-700 max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="p-6 border-b border-slate-700 flex justify-between items-center bg-slate-800/50">
              ...
              {extractedData.confidence_score && (
                <span
                  className={`text-sm px-3 py-1.5 rounded-full ${extractedData.confidence_score > 0.8 ? 'bg-green-500/20 text-green-300' : 'bg-yellow-500/20 text-yellow-300'}`}
                >
              ...
              {extractedData.customer_name && (
                <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3">
                  <p className="text-sm text-blue-300">
                    <span className="font-medium">Extracted Customer:</span>{' '}
                    {extractedData.customer_name}
                  </p>
                  <p className="text-xs text-slate-400 mt-1">
                    Select the matching customer below or leave blank for cash sale
                  </p>
                </div>
              )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      setModalFormData({ ...modalFormData, customerId: e.target.value })
                    }
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      setModalFormData({ ...modalFormData, paymentMethod: e.target.value })
                    }
                  >
                        ...
                        <tr key={idx} className="hover:bg-slate-800/50">
                          ...
                          <td className="p-3">
                            <input
                              ...
                              value={item.quantity}
                              onChange={e =>
                                updateModalItem(idx, 'quantity', parseInt(e.target.value) || 0)
                              }
                            />
                          </td>
                          <td className="p-3">
                            <input
                              ...
                              onChange={e =>
                                updateModalItem(idx, 'unitPrice', parseFloat(e.target.value) || 0)
                              }
                            />
                          </td>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        setModalFormData({ ...modalFormData, initialPaidAmount: e.target.value })
                      }
