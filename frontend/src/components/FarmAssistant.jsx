...
export default function FarmAssistant() {
  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      text: 'Hello! I am your Farm Assistant. Ask me about your sales, stock, or general poultry questions.',
    },
  ]);
  ...
  const handleSend = async e => {
    ...
    try {
      ...
      const errorMessage =
        error.response?.data?.reply || error.message || 'An unexpected error occurred.';
